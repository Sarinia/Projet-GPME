 ...
 */
final class Version20190607074621 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, passport_id INT NOT NULL, prob1 TINYINT(1) DEFAULT NULL, prob2 TINYINT(1) DEFAULT NULL, prob3 TINYINT(1) DEFAULT NULL, numbersp INT NOT NULL, mod1 TINYINT(1) DEFAULT NULL, mod2 TINYINT(1) DEFAULT NULL, mod3 TINYINT(1) DEFAULT NULL, cond1 TINYINT(1) DEFAULT NULL, cond2 TINYINT(1) DEFAULT NULL, cond3 TINYINT(1) DEFAULT NULL, entitledsp VARCHAR(255) DEFAULT NULL, infossp VARCHAR(255) DEFAULT NULL, framesp VARCHAR(255) DEFAULT NULL, problemmanagsp VARCHAR(255) DEFAULT NULL, problemcomosp VARCHAR(255) DEFAULT NULL, problemcomwsp VARCHAR(255) DEFAULT NULL, actorssp VARCHAR(255) DEFAULT NULL, targetsp VARCHAR(255) DEFAULT NULL, conditionssp VARCHAR(255) DEFAULT NULL, resourcessp VARCHAR(255) DEFAULT NULL, answerssp VARCHAR(255) DEFAULT NULL, productionssp VARCHAR(255) DEFAULT NULL, writtensp VARCHAR(255) DEFAULT NULL, oralsp VARCHAR(255) DEFAULT NULL, contributionsp LONGTEXT DEFAULT NULL, analysissp LONGTEXT DEFAULT NULL, exist TINYINT(1) NOT NULL, INDEX IDX_161498D3CB944F1A (student_id), INDEX IDX_161498D3ABF410D0 (passport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
